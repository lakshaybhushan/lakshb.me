    ...
    return (
        <section id='home'>
            {/* <motion.div
                ...
                <p className='md:text-[2.75rem] text-[1.6rem] md:w-[60rem] leading-tight bottom-5 md:absolute text-center md:text-left mt-10 md:mt-0 px-10 md:px-0 py-10 md:py-0'>hey!! I’m lakshay, a 19 yr old cs student at <a href='https://www.iiitd.ac.in/' target='_blank' rel="noopener noreferrer" className='underline decoration-solid hover:text-highlight-blue transition-colors duration-500'>iiit delhi</a> who likes to build websites & other dev stuff with minimal user interfaces.</p>
            {/* </motion.div> */}
            </div>
        </section>
    )
