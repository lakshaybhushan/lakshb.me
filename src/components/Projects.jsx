...
export const Projects = () => {
  ...
  return (
    <section id="projects">
      ...
      <div className="md:ml-8 font-Outfit md:h-screen md:pt-10 pt-5">
            ...
            <div className="bg-box-gray py-6 px-10 rounded-xl md:w-[54rem] md:hover:text-black transition-all duration-500 md:hover:bg-pxorange mx-10 md:mx-0">
              <a
                ...
                <div className="flex flex-row items-center">
                  <h1 className="text-[2rem] h-[2.5rem] font-Bebas-Neue">
                    pixelverse
                  </h1>
                  <BsBoxArrowUpRight size={22} className="bsarrow ml-3" />
                </div>
                <p className="md:text-[1.5rem] text-[1.3rem] leading-tight md:leading-normal">
